...
public  interface CheckAnalysis extends org.apache.spark.sql.catalyst.expressions.PredicateHelper, org.apache.spark.sql.connector.catalog.LookupCatalog {
   ...
   * @param isScalarOrLateral (undocumented)
   */
  public  void checkCorrelationsInSubquery (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan sub, boolean isScalarOrLateral)  ;
