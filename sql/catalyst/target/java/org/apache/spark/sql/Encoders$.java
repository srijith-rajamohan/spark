...
public  class Encoders$ {
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.Encoder<java.time.LocalDateTime> LOCALDATETIME ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.Encoder<java.time.Duration> DURATION ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.Encoder<java.time.Period> PERIOD ()  { throw new RuntimeException(); }
  /**
