...
public  class DecorrelateInnerQuery$ implements org.apache.spark.sql.catalyst.expressions.PredicateHelper {
  ...
  /**
   * Rewrite all {@link DomainJoin}s in the inner query to actual inner joins with the outer query.
