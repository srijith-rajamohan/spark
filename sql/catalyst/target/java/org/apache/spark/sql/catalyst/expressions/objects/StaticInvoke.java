...
public  class StaticInvoke extends org.apache.spark.sql.catalyst.expressions.Expression implements org.apache.spark.sql.catalyst.expressions.objects.InvokeLike, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   StaticInvoke (java.lang.Class<?> staticObject, org.apache.spark.sql.types.DataType dataType, java.lang.String functionName, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> arguments, scala.collection.Seq<org.apache.spark.sql.types.AbstractDataType> inputTypes, boolean propagateNull, boolean returnNullable)  { throw new RuntimeException(); }
