...
public  class Invoke extends org.apache.spark.sql.catalyst.expressions.Expression implements org.apache.spark.sql.catalyst.expressions.objects.InvokeLike, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   Invoke (org.apache.spark.sql.catalyst.expressions.Expression targetObject, java.lang.String functionName, org.apache.spark.sql.types.DataType dataType, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> arguments, scala.collection.Seq<org.apache.spark.sql.types.AbstractDataType> methodInputTypes, boolean propagateNull, boolean returnNullable)  { throw new RuntimeException(); }
  // not preceding
