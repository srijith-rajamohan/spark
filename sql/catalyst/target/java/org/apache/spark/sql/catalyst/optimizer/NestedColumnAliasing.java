...
public  class NestedColumnAliasing {
   ...
   * @return (undocumented)
   */
  static public  scala.collection.immutable.Map<org.apache.spark.sql.catalyst.expressions.Attribute, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.ExtractValue>> getAttributeToExtractValues (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> exprList, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> exclusiveAttrs)  { throw new RuntimeException(); }
}
