...
public  class ShufflePartitionsUtil$ implements org.apache.spark.internal.Logging {
   ...
   * @return (undocumented)
   */
    int[] splitSizeListByTargetSize (scala.collection.Seq<java.lang.Object> sizes, long targetSize)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Option<scala.collection.Seq<org.apache.spark.sql.execution.PartialReducerPartitionSpec>> createSkewPartitionSpecs (int shuffleId, int reducerId, long targetSize)  { throw new RuntimeException(); }
}
