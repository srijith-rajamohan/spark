...
public  class MergingSessionsExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.aggregate.BaseAggregateExec, scala.Product, scala.Serializable {
  ...
  public  scala.Option<scala.collection.Seq<org.apache.spark.sql.catalyst.plans.physical.Distribution>> requiredChildDistributionOption ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   MergingSessionsExec (scala.Option<scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression>> requiredChildDistributionExpressions, scala.Option<scala.collection.Seq<org.apache.spark.sql.catalyst.plans.physical.Distribution>> requiredChildDistributionOption, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.NamedExpression> groupingExpressions, org.apache.spark.sql.catalyst.expressions.NamedExpression sessionExpression, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.aggregate.AggregateExpression> aggregateExpressions, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> aggregateAttributes, int initialInputBufferOffset, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.NamedExpression> resultExpressions, org.apache.spark.sql.execution.SparkPlan child)  { throw new RuntimeException(); }
  // not preceding
