...
public  class ViewHelper$ implements org.apache.spark.sql.catalyst.SQLConfHelper, org.apache.spark.internal.Logging {
   ...
   */
  public  void verifyTemporaryObjectsNotExists (org.apache.spark.sql.catalyst.catalog.SessionCatalog catalog, boolean isTemporary, org.apache.spark.sql.catalyst.TableIdentifier name, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan child)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.catalyst.catalog.TemporaryViewRelation createTemporaryViewRelation (org.apache.spark.sql.catalyst.TableIdentifier name, org.apache.spark.sql.SparkSession session, boolean replace, scala.Function1<java.lang.String, scala.Option<org.apache.spark.sql.catalyst.catalog.TemporaryViewRelation>> getRawTempView, scala.Option<java.lang.String> originalText, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan analyzedPlan, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan aliasedPlan)  { throw new RuntimeException(); }
}
