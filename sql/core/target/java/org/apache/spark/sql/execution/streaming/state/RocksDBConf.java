...
public  class RocksDBConf implements scala.Product, scala.Serializable {
  ...
  public  boolean pauseBackgroundWorkForCommit ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   RocksDBConf (int minVersionsToRetain, boolean compactOnCommit, boolean pauseBackgroundWorkForCommit, long blockSizeKB, long blockCacheSizeMB, long lockAcquireTimeoutMs)  { throw new RuntimeException(); }
}
