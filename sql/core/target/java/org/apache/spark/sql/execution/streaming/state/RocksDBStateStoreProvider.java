package org.apache.spark.sql.execution.streaming.state;
  ...
  public  class StateEncoder {
    public   StateEncoder ()  { throw new RuntimeException(); }
    /**
     ...
     * @return (undocumented)
     */
    public  byte[] encode (org.apache.spark.sql.catalyst.expressions.UnsafeRow row)  { throw new RuntimeException(); }
  }
  ...
  static public  org.apache.spark.sql.execution.streaming.state.StateStoreCustomSizeMetric CUSTOM_METRIC_FILES_COPIED ()  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.execution.streaming.state.StateStoreCustomSizeMetric CUSTOM_METRIC_FILES_REUSED ()  { throw new RuntimeException(); }
