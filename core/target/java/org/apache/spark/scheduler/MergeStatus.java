 ...
 */
  ...
  static public  org.apache.spark.scheduler.MergeStatus apply (org.apache.spark.storage.BlockManagerId loc, org.roaringbitmap.RoaringBitmap bitmap, long size)  { throw new RuntimeException(); }
  public   MergeStatus (org.apache.spark.storage.BlockManagerId loc, org.roaringbitmap.RoaringBitmap mapTracker, long size)  { throw new RuntimeException(); }
