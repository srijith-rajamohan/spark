...
public  class MergeStatus$ implements scala.Serializable {
  ...
  public  org.apache.spark.scheduler.MergeStatus apply (org.apache.spark.storage.BlockManagerId loc, org.roaringbitmap.RoaringBitmap bitmap, long size)  { throw new RuntimeException(); }
}
