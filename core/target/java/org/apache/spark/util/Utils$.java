...
public  class Utils$ implements org.apache.spark.internal.Logging {
   ...
   * @return (undocumented)
   */
  public  boolean isPushBasedShuffleEnabled (org.apache.spark.SparkConf conf)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getYarnMaxAttempts (org.apache.spark.SparkConf conf)  { throw new RuntimeException(); }
  /**
  ...
  public  long executorTimeoutMs (org.apache.spark.SparkConf conf)  { throw new RuntimeException(); }
