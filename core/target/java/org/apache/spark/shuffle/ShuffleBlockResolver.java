...
public  interface ShuffleBlockResolver {
   ...
   * @return (undocumented)
   */
  public  scala.collection.Seq<org.apache.spark.network.buffer.ManagedBuffer> getMergedBlockData (org.apache.spark.storage.ShuffleBlockId blockId, scala.Option<java.lang.String[]> dirs)  ;
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.network.shuffle.MergedBlockMeta getMergedBlockMeta (org.apache.spark.storage.ShuffleBlockId blockId, scala.Option<java.lang.String[]> dirs)  ;
  public  void stop ()  ;
}
