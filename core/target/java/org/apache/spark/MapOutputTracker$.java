...
public  class MapOutputTracker$ implements org.apache.spark.internal.Logging {
   ...
   */
  public  scala.collection.Iterator<scala.Tuple2<org.apache.spark.storage.BlockManagerId, scala.collection.Seq<scala.Tuple3<org.apache.spark.storage.BlockId, java.lang.Object, java.lang.Object>>>> convertMapStatuses (int shuffleId, int startPartition, int endPartition, org.apache.spark.scheduler.MapStatus[] mapStatuses, int startMapIndex, int endMapIndex, scala.Option<org.apache.spark.scheduler.MergeStatus[]> mergeStatuses)  { throw new RuntimeException(); }
  /**
