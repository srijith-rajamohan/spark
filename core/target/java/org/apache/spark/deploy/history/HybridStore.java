 ...
 */
  ...
  static public  interface SwitchToLevelDBListener {
    public  void onSwitchToLevelDBFail (java.lang.Exception e)  ;
    public  void onSwitchToLevelDBSuccess ()  ;
  }
  ...
  public  void setLevelDB (org.apache.spark.util.kvstore.LevelDB levelDB)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  void switchToLevelDB (org.apache.spark.deploy.history.HybridStore.SwitchToLevelDBListener listener, java.lang.String appId, scala.Option<java.lang.String> attemptId)  { throw new RuntimeException(); }
  /**
